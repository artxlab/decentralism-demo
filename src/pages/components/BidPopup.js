...
export default class Popup extends Component {
        ...
        switch(s) {
            case 1:
                return (
                    <div className='mx-auto'>
                        <p className='artx-type-et text-center text-warning'>Please login to your Metamask first</p>
                        ...
                        <div className='artx-shares-btn text-center amb-9'>
                            <button className="mr-4">
                                <span className='d-inline-block px-4 py-1'>
                                    <span className='artx-type-et artx-gradient-text'>1X
                                    </span>
                                </span>
                            </button>
                            <button className="mr-4">
                                <span className='d-inline-block px-4 py-1'>
                                    <span className='artx-type-et artx-gradient-text'>10X
                                    </span>
                                </span>
                            </button>
                            <button className="mr-4">
                                <span className='d-inline-block px-4 py-1'>
                                    <span className='artx-type-et artx-gradient-text'>100X
                                    </span>
                                </span>
                            </button>
                            <button className="mr-4">
                                <span className='d-inline-block px-4 py-1'>
                                    <span className='artx-type-et artx-gradient-text'>AVE
                                    </span>
                                </span>
                            </button>
                            <button className="mr-4">
                                <span className='d-inline-block px-4 py-1'>
                                    <span className='artx-type-et artx-gradient-text'>MAX
                                    </span>
                                </span>
                            </button>
                        </div>
            ...
            case 3:
                if (b === true) {
                    return (
                        <div className='mx-auto artx-bid-content'>
                            <p className='artx-type-et artx-gradient-text mb-4'>Good news! You will receive a 10% bonus because you are referred by a friend!</p>
                            <p className='artx-type-et text-center text-warning amb-8'>NOTICE:  Login to Metamask to try again!</p>
                    ...
                    return (
                        <div className='mx-auto artx-bid-content'>
                            ...
                            <p className='text-center artx-type-et text-warning amb-8'>NOTICE:  Login to Metamask to try again!</p>
                            <button className='d-block mx-auto artx-btn artx-type-et text-center text-white py-2 apx-13' type='button' onClick={() => this.setStep(1)}>Bid</button>
                        </div>
                    );
                }
    ...
    render() {
        ...
        return (
            <div>
                <button className='d-block ml-auto artx-btn text-white artx-type-et py-3 apx-14' onClick={() => this.setState({isOpen: true})}>Bid <i className="fas fa-gavel"></i></button>
                { isOpen
                    ...
                    <div className='artx-gradient-inner pt-4 apb-14 w-100'>
                        {
                            ...
                            ?
                                <button type="button" className="d-block ml-auto amr-9 artx-icon-btn" aria-label="Close" onClick={this.closeBid}>
                                    <i className="fas fa-times artx-type-et artx-gradient-text"></i>
                                </button>
                            : <div className='d-flex justify-content-between amx-9'>
                                <button type="button" className='artx-icon-btn' aria-label='Go back to previous step' onClick={() => this.setStep(-1)}>
                                    <i className="artx-type-et fas fa-chevron-left artx-gradient-text"></i>
                                </button>
